...
const CarForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <input name="registrationNumber" value={car.registrationNumber} onChange={handleChange} placeholder="Registration Number" required />
      <input name="owner" value={car.owner} onChange={handleChange} placeholder="Owner" required />
